...
* [Submit a post for your issue](https://github.com/trainome/seqwrappaper/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/trainome/seqwrappaper/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:

    `git clone git@github.com:your-username/seqwrappaper.git`
...
Push to your fork and [submit a pull request](https://github.com/trainome/seqwrappaper/compare/).
...
* Engage in discussion on [your issue](https://github.com/trainome/seqwrappaper/issues/).
